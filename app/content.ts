...
export const LEGAL: ProseSection = {
  ...
  paras: {
    de: [
      "DSGVO-konform durch Architektur, nicht durch Vertrag — die Daten liegen lokal, ein Abfluss ist technisch nicht vorgesehen.",
      ...
      "Prüfprotokoll: jede KI-Anfrage sichtbar. Löschen jederzeit (DSGVO Art. 17).",
      "Hinweis: Die konkrete DSGVO- und MDR-Bewertung erfolgt mit einem Anwalt — kein Marketingversprechen.",
    ],
    en: [
      "GDPR-compliant by architecture, not by contract — data stays local; there is no path out by design.",
      ...
      "Audit log: every AI request is visible. Deletion anytime (GDPR Art. 17).",
...
export const FAQ: Faq[] = [
  ...
  { de: { q: "Kann ich alles löschen?", a: "Ja, ein Klick. Ihre Daten gehören Ihnen, jederzeit exportierbar. Kein Lock-in." }, en: { q: "Can I delete everything?", a: "Yes, one click. Your data is yours, exportable anytime. No lock-in." } },
